...
2021 **Программирование на Java для тестировщиков** Лаборатория Качества, Автоматизауия Тестирования ПО

2021 **Школа инженеров по автоматизации тестирования** QA.GURU, Автоматизауия Тестирования ПО - in progress
